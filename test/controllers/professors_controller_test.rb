...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { data_admissao: @professor.data_admissao, nome_completo: @professor.nome_completo }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { data_admissao: @professor.data_admissao, nome_completo: @professor.nome_completo }
    assert_redirected_to professor_path(assigns(:professor))
  end
